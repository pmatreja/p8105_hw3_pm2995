...
< 100 separately per year(I have used density ridges to show the distribution of the data). bith the plots were shown in the same graphic by using the patchwork package.
