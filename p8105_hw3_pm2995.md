...
<img src="p8105_hw3_pm2995_files/figure-markdown_github/unnamed-chunk-16-1.png" width="90%" />
...
Overall positive correlation can be seen between tmax and tmin with few outliers. Referring the color gradient, we can see that for most of the days tmax 25 and tmin around 14 was seen(count 50000). For the snowfall plot, for most of the years it can be seen that distribution of snowfall is pretty consistent. The peaks lie around 10 and 25. From 2006 - 2010, it can be seen that the height of the first peak (indicating the value of 10 mm ) increased as compared to other years.
